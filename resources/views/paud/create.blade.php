...
<div class="container-fluid">
    ...
    <h1 class="h3 mb-4 text-gray-800">Tambah Data PAUD</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="jenis_izin" class="form-control">
                            ...
                            <option value="baru" {{ old('jenis_izin') == 'baru' ? 'selected' : '' }}>Baru</option>
                            <option value="perpanjangan" {{ old('jenis_izin') == 'perpanjangan' ? 'selected' : '' }}>Perpanjangan</option>
                            <option value="operasional" {{ old('jenis_izin') == 'operasional' ? 'selected' : '' }}>Operasional</option>
                        </select>
                    </div>
